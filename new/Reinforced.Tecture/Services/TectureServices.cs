...
namespace Reinforced.Tecture.Services {	
			   ...
			   
    {
        ...
        {
            return new SRead<T, T1, T2>(ChannelMultiplexer, QueryStore);
        }		
			   ...
			   
    {
        ...
        {
            return new SRead<T, T1, T2, T3>(ChannelMultiplexer, QueryStore);
        }		
			   ...
			   
    {
        ...
        {
            return new SRead<T, T1, T2, T3, T4>(ChannelMultiplexer, QueryStore);
        }		
			   ...
			   
    {
        ...
        {
            return new SRead<T, T1, T2, T3, T4, T5>(ChannelMultiplexer, QueryStore);
        }		
			   ...
			   
    {
        ...
        {
            return new SRead<T, T1, T2, T3, T4, T5, T6>(ChannelMultiplexer, QueryStore);
        }		
			   ...
			   
    {
        ...
        {
            return new SRead<T, T1, T2, T3, T4, T5, T6, T7>(ChannelMultiplexer, QueryStore);
        }		
			   ...
			   
    {
        ...
        {
            return new SRead<T, T1, T2, T3, T4, T5, T6, T7, T8>(ChannelMultiplexer, QueryStore);
        }		
