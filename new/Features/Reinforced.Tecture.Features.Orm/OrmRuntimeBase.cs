...
namespace Reinforced.Tecture.Methodics.Orm
{
    public abstract class OrmRuntimeBase : ITectureRuntime, IDisposable
    {
        ...
        /// <returns></returns>
        public virtual CommandRunner GetRunner(CommandBase command)
        {
        ...
        protected abstract CommandRunner<Add> ProvideAddRunner(Add command);
        protected abstract CommandRunner<Delete> ProvideDeleteRunner(Delete command);
        protected abstract CommandRunner<Update> ProvideUpdateRunner(Update command);
