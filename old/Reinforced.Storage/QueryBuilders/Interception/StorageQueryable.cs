...
{
    struct StorageQueryable : IQueryable
    {
        private readonly StorageQueryProvider _provider;
        private readonly IQueryable _originalQueryable;

        public StorageQueryable(IQueryable originalQueryable, StorageQueryProvider provider)
        {
    ...
    struct StorageQueryable<T> : IQueryable<T>
    {
        private readonly StorageQueryProvider _provider;
        private readonly IQueryable<T> _originalQueryable;

        public StorageQueryable(IQueryable<T> originalQueryable, StorageQueryProvider provider)
        {
            _originalQueryable = originalQueryable;
            _provider = provider;
        }
