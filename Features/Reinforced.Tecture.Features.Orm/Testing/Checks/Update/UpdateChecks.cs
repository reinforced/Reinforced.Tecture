...
namespace Reinforced.Tecture.Features.Orm.Testing.Checks.Update
{
    public static class UpdateChecks
    {
        ...
        public static UpdatePredicateCheck<T> Update<T>(Func<T, bool> predicate, string explanation, Memorize<T> mem) => new UpdatePredicateCheck<T>(predicate, explanation, mem);
    }
}
