...
namespace Reinforced.Tecture.Features.Orm.Commands.DeletePk
{
    public static partial class Extensions
    {
        ...
        {
            var a = (DeletePkOperation<IPrimaryKey<T1>>) c;
        ...
        {
            var a = (DeletePkOperation<IPrimaryKey<T1, T2>>) c;
        ...
        {
            var a = (DeletePkOperation<IPrimaryKey<T1, T2, T3>>) c;
        ...
        {
            var a = (DeletePkOperation<IPrimaryKey<T1, T2, T3, T4>>) c;
        ...
        {
            var a = (DeletePkOperation<IPrimaryKey<T1, T2, T3, T4, T5>>) c;
        ...
        {
            var a = (DeletePkOperation<IPrimaryKey<T1, T2, T3, T4, T5, T6>>) c;
        ...
        {
            var a = (DeletePkOperation<IPrimaryKey<T1, T2, T3, T4, T5, T6, T7>>) c;
