...
namespace Reinforced.Tecture.Runtimes.EFCore.Features.Orm
{
    public static class Extensions
    {
        ...
        public static void UseEfCoreOrmCommand(this ChannelConfiguration<CommandChannel<Tecture.Features.Orm.Command>> conf, LazyDisposable<DbContext> context)
        {
        ...
        /// <param name="conf">Channel configuration</param>
        /// <param name="context">Lazy disposable wrapper around DbContext</param>
        public static void UseEfCoreOrmQuery(this ChannelConfiguration<QueryChannel<Tecture.Features.Orm.Query>> conf, LazyDisposable<DbContext> context)
        {
        ...
        /// <param name="conf">Channel configuration</param>
        /// <param name="context">Lazy disposable wrapper around DbContext</param>
        public static void UseEfCoreOrm(this ChannelConfiguration<CommandQueryChannel<Tecture.Features.Orm.Command, Tecture.Features.Orm.Query>> conf, LazyDisposable<DbContext> context)
        {
