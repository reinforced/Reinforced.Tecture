...
namespace Reinforced.Tecture.Aspects.Orm.Testing.Checks.UpdatePk
{
    ...
    public class UpdatePkDictionaryCheck<T> : CommandCheck<Commands.UpdatePk.UpdatePk>
    {
        private readonly Dictionary<string, object> _expectedValues;
        private readonly string _explanation;

        internal UpdatePkDictionaryCheck(Dictionary<string, object> expectedValues, string explanation)
        {
