...
{
    public partial class TestingEnvironment
    {
        ...
        internal IList GetCollection(Type t)
        {
        ...
        /// </summary>
        public TestingEnvironment Prefetched<T>(IEnumerable<T> collection)
        {
        ...
        /// Adds prefetched data to test data collection
        /// </summary>
        public TestingEnvironment Prefetched<T>(IQueryable<T> collection) where T : class
        {
        ...
        public virtual IQueryable<TEntity> NoTracking<TEntity>(IQueryable<TEntity> q) where TEntity : class => q;
        public virtual IQueryable<TEntity> Include<TEntity>(IQueryable<TEntity> q, Expression includeExpression) where TEntity : class => q;
    }
}
