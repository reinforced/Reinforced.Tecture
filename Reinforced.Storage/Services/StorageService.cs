...
namespace Reinforced.Storage.Services
{
    public partial class StorageService : IDisposable
    {
        ...
        internal StrokeProcessor StrokeProcessor { get; set; }
        ...
        internal SetManager SetManager { get; set; }
        internal Effects _effects;
        protected Effects Effects => _effects;
        #endregion
        ...
        {
            Validate<TEntity>();
            return Effects.Enqueue(new AddSideEffect() { Entity = entity, EntityType = typeof(TEntity) });
        }
        ...
        {
            Validate<TEntity>();
            return Effects.Enqueue(new RemoveSideEffect() { Entity = entity, EntityType = typeof(TEntity) });
        }
        ...
        {
            Validate<TEntity>();
            return Effects.Enqueue(new UpdateSideEffect(entity, typeof(TEntity)));
        }
        ...
        {
            Validate<TEntity>();
            return Effects.Enqueue(new UpdateSideEffect(entity, typeof(TEntity), properties));
        }
        ...
        {
            return Effects.Enqueue(new DirectSqlSideEffect(command, parameters));
        }
        ...
        /// <summary>
        /// Comments some activity. Comment goes directly to effects queue as fake side-effect
        /// </summary>
        /// <param name="comment">Comment text</param>
        [Unexplainable]
        protected void Comment(string comment)
        {
            Effects.Enqueue(new CommentSideEffect() {Annotation = comment});
        }
    }
    ...
    /// </summary> 
    public class StorageService<T1> : StorageService
        where T1 : class
    {
        /// <summary>
