...
namespace Reinforced.Storage.Services {
	...
	public static partial class DoExtensions
    {
		...
		public static TService Within<TService, T1, T2>(this LetBuilder<TService> db, T1 arg1, T2 arg2) 
			where TService : StorageService, IContext<T1, T2>
        {
            return db.Init(
		...
		public static TService Within<TService, T1, T2, T3>(this LetBuilder<TService> db, T1 arg1, T2 arg2, T3 arg3) 
			where TService : StorageService, IContext<T1, T2, T3>
        {
            return db.Init(
		...
		public static TService Within<TService, T1, T2, T3, T4>(this LetBuilder<TService> db, T1 arg1, T2 arg2, T3 arg3, T4 arg4) 
			where TService : StorageService, IContext<T1, T2, T3, T4>
        {
            return db.Init(
		...
		public static TService Within<TService, T1, T2, T3, T4, T5>(this LetBuilder<TService> db, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) 
			where TService : StorageService, IContext<T1, T2, T3, T4, T5>
        {
            return db.Init(
		...
		public static TService Within<TService, T1, T2, T3, T4, T5, T6>(this LetBuilder<TService> db, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6) 
			where TService : StorageService, IContext<T1, T2, T3, T4, T5, T6>
        {
            return db.Init(
		...
		public static TService Within<TService, T1, T2, T3, T4, T5, T6, T7>(this LetBuilder<TService> db, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7) 
			where TService : StorageService, IContext<T1, T2, T3, T4, T5, T6, T7>
        {
            return db.Init(
		...
		public static TService Within<TService, T1, T2, T3, T4, T5, T6, T7, T8>(this LetBuilder<TService> db, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8) 
			where TService : StorageService, IContext<T1, T2, T3, T4, T5, T6, T7, T8>
        {
            return db.Init(
    ...
    /// </summary>    
	public class StorageService<T1, T2>
			   : StorageService<T1>
			   where T1: class
			   where T2 : class
			       {
    ...
    /// </summary>    
	public class StorageService<T1, T2, T3>
			   : StorageService<T1, T2>
			   where T1: class
			   where T2 : class
			   where T3 : class
			       {
    ...
    /// </summary>    
	public class StorageService<T1, T2, T3, T4>
			   : StorageService<T1, T2, T3>
			   where T1: class
			   where T2 : class
			   where T3 : class
			   where T4 : class
    ...
    /// </summary>    
	public class StorageService<T1, T2, T3, T4, T5>
			   : StorageService<T1, T2, T3, T4>
			   where T1: class
			   where T2 : class
			   where T3 : class
			   where T4 : class
    ...
    /// </summary>    
	public class StorageService<T1, T2, T3, T4, T5, T6>
			   : StorageService<T1, T2, T3, T4, T5>
			   where T1: class
			   where T2 : class
			   where T3 : class
			   where T4 : class
    ...
    /// </summary>    
	public class StorageService<T1, T2, T3, T4, T5, T6, T7>
			   : StorageService<T1, T2, T3, T4, T5, T6>
			   where T1: class
			   where T2 : class
			   where T3 : class
			   where T4 : class
    ...
    /// </summary>    
	public class StorageService<T1, T2, T3, T4, T5, T6, T7, T8>
			   : StorageService<T1, T2, T3, T4, T5, T6, T7>
			   where T1: class
			   where T2 : class
			   where T3 : class
			   where T4 : class
